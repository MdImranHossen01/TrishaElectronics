...
export function AIChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: 'Hi there! I am your Trishna Electronics AI assistant. How can I help you today?' },
  ]);
          ...
          >
            ...
            <div className="p-4 bg-primary text-primary-foreground flex items-center justify-between shadow-md">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm">Trishna Electronics AI</h3>
