...
export const metadata: Metadata = {
  title: 'About Us | Trishna Electronics',
  description: 'Trishna Electronics - Premium electronics and security store in Bangladesh. Explore our high-quality collection of IP cameras, smart LED TVs, high-definition projectors, and professional CC camera systems.',
};
...
export default async function AboutPage() {
  ...
  const brandName = settings?.brandName || "Trishna Electronics";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                At Trishna Electronics, we believe that modern surveillance and entertainment systems should be high-quality, accessible, and user-friendly. We curate the finest products—whether you require a smart IP camera for wireless home security, full-featured CC camera packages for commercial monitoring, premium LED TVs, or immersive home theater projectors.
              </p>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
      ...
      <section className="py-20 text-center relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 space-y-6">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight max-w-2xl mx-auto leading-tight">
            Upgrade Your Setup with Trishna Electronics
          </h2>
