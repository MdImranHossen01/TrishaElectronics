...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  const marqueeText = settings?.marqueeText || 'Welcome to Trishna Electronics! Free shipping on orders over $500.';
  const ui = {
  ...
  return (
    <>
      {showBlocker && <SubscriptionBlocker brandName={settings?.brandName || 'Trishna Electronics'} />}
