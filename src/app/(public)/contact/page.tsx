...
export const metadata: Metadata = {
  title: 'Contact Us | Trishna Electronics',
  description: 'Get in touch with Trishna Electronics for any inquiries, support, or feedback.',
};
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="aspect-video w-full rounded-2xl overflow-hidden shadow-md border bg-muted">
                  <iframe
                    title="Trishna Electronics Location"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
