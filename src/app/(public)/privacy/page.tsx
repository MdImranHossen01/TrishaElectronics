...
export const metadata: Metadata = {
  title: 'Privacy Policy | Trishna Electronics',
  description: 'Learn how Trishna Electronics collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@trishnaelectronics.com";
