  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Trishna Electronics",
        contact: {
        ...
        marqueeText: "Welcome to Trishna Electronics!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Trishna Electronics",
